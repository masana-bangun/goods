...
const translations = {
  ...
  zh: {
    ...
    expression_6_desc:
      "你来到这个世界是为了以爱、责任感、责任心和仁慈服务人类。你将被公认为一个可靠的人。对你所爱的人要慷慨，但不要到牺牲的地步。在你的一生中，会有人敲你的门寻求帮助，你为他人做得越多，你就会被越多的爱、舒适和金钱所包围。为了你自己的进步，你需要美丽、陪伴、爱与和谐。你能够探索人生的哲理，并达到精神上的高峰",
    expression_7_desc:
